...
namespace RealMerchPlan.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UPC,Name,Size,Height,Width,Depth")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UPC,Name,Size,Height,Width,Depth")] Product product)
        {
            if (ModelState.IsValid)
            {
